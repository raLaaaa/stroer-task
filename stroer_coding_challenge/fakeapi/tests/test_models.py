...
class PostTest(TestCase):
    ...
    def test_posts(self):
        ...
        self.assertEqual(post_one.title, "Post One Title")
        self.assertEqual(post_two.title, "Post Two Title")
        self.assertEqual(comment_one.name, "Marcel")
        self.assertEqual(comment_two.name, "Test Name")
        self.assertEqual(comment_one.post, post_one)
        self.assertEqual(comment_two.post, post_two)
        self.assertEqual(post_one.user_id, 99999942)
        self.assertEqual(post_two.user_id, 99999942)
